...
parser.add_argument('-lr_decay_ep', type=int, default=200, help='the number of epochs for decay learning rate')
...
parser.add_argument('-hidden', type=int, default=512, help='the number of hidden node of the main MLP')
...
# eval opt
parser.add_argument('-eval', action='store_true', help='load ckpt and measure (PSNR/SSIM/LPIPS')
